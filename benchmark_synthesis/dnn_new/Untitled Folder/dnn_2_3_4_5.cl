...
__kernel void dnn_2_3_4_5( __global const float* b0, __global const float* b1, __global const float* b2, __global const float* b3, __global const float* b4, __global const float* b5, __global const float* b6, __global const float* b7, __global const float* b8, __global float* b9, __global float* b10, __global float* b11, __global float* b12)
{
	...
	if(globalId < v4)
	{
		...
		{
			temp= vload4(0,(__global const float *)b10+(4*x));
