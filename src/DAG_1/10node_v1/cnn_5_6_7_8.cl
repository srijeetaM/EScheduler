__kernel void cnn_5_6_7_8( __global const float* b0, __global const float* b2, __global const float* b4, __global const float* b6, __global float* b1, __global float* b3, __global float* b5, __global float* b7)
{
