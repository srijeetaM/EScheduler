__kernel void cnn_4_5_6( __global const float* b0, __global const float* b1, __global const float* b2, __global const float* b5, __global float* b3, __global float* b4, __global float* b6)
{
