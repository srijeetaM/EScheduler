__kernel void cnn_6_7_8_9( __global const float* b0, __global const float* b1, __global const float* b3, __global const float* b5, __global float* b2, __global float* b4, __global float* b6, __global float* b7)
{
