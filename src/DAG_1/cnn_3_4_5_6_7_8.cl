__kernel void cnn_3_4_5_6_7_8( __global const float* b0, __global const float* b2, __global const float* b3, __global const float* b6, __global const float* b8, __global const float* b10, __global float* b1, __global float* b4, __global float* b5, __global float* b7, __global float* b9, __global float* b11)
{
